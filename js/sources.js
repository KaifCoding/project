...
const source = window.location.pathname.split("/")[2].split(".")[0];
const url = `${baseUrl}/everything/${source}.json`;
const newsContainer = document.getElementById(`${source}-news-section`);
